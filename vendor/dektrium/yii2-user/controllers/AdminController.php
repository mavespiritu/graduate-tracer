...
class AdminController extends Controller
{
    ...
    public function actionIndex()
    {
        ...
        $params['UserSearch']['course_id'] = isset($params['UserSearch']['course_id']) ? $params['UserSearch']['course_id'] : null;
        $params['UserSearch']['major_id'] = isset($params['UserSearch']['major_id']) ? $params['UserSearch']['major_id'] : null;

        $additionalParams = [];
        $dataProvider = $searchModel->search($params, $additionalParams);

        $courses = Course::find()->asArray()->orderBy(['name' => SORT_ASC])->all();
        $majors = Major::find()->asArray()->orderBy(['name' => SORT_ASC])->all();
