...
$script = '
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/alumni-data']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/respondent-rate']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/multi-degree-holder']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/employment']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/job-classification']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/job-location']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
    ...
    {
        $.ajax({
            url: "'.Url::to(['/site/job-gross']).'?year=" + year + "&course_id=" + course_id + "&major_id=" + major_id,
            beforeSend: function(){
